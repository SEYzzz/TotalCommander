...
namespace TotalCommander
{
    ...
    class CardForFile : Panel
    {
        ...
        public CardForFile( string path)
        {
            IsClicked = false;
            ...
            if (Directory.Exists(path))
            {
                ...
                PictureFile.BackgroundImage = Properties.Resources.DirectoryFile;
                foreach (DriveInfo drive in DriveInfo.GetDrives())
                {
                    if (drive.Name.Equals(path))
                    {
                        NameFile.Text = drive.Name;
                        PictureFile.BackgroundImage = Properties.Resources.DiskDrive;
            ...
            else if (File.Exists(path))
            {
                ...
                PictureFile.BackgroundImage = Properties.Resources.File_alt_font_awesome_svg;
